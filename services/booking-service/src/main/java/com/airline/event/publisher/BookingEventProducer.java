package com.airline.event.publisher;
...
public class BookingEventProducer {
    ...
    public void sendBookingConfirmed(Booking booking,
        ...
        Instant depTime = flight != null ? flight.getDepartureDateTime() : null;
        Instant arrTime = flight != null ? flight.getArrivalDateTime()   : null;
        ...
        BookingConfirmedEvent event = BookingConfirmedEvent.builder()
                ...
                .cabinClass(booking.getCabinClass() != null ? booking.getCabinClass().name() : CabinClassType.ECONOMY.name())
